...
export default function Arena() {
  ...
  //Initialize WS connection to handle URL params
  useEffect(() => {
  ...
  const handleWebSocketMessage = (message: any) => {
    switch (message.type) {
      case "space-joined":
        //Initialize current user position and other uses,
        console.log("set")
        console.log({
  ...
  return (
    <>
      <div className="p-4" tabIndex={0} onKeyDown={handleKeyDown}>
        ...
        <p className="mt-2 text-sm text-gray-500">Use arrow keys to move</p>
      </div>
    </>
  )
}
